...
<body>
  ...
  <section class="hero">
    <div class="container text-center">
      ...
      <div class="col-md-12">
        ...
        <p class="tagline">
          This is a powerful bank with some great features that you can use in to make your savings and transactions in best ways.
        </p>
        <a class="btn btn-full" href="viewcustomers.jsp">View Customers</a>
        <a class="btn btn-full" href="viewtransactions.jsp">View Transactions</a>
      </div>
    </div>
  ...
  <div class="block bg-primary block-pd-lg block-bg-overlay text-center" data-bg-img="img/parallax-bg.jpg" data-settings='{"stellar-background-ratio": 0.6}' data-toggle="parallax-bg">
    <h2>
        Welcome to a bell bank
      </h2>

    <p>
      This is the most powerful bank with thousands of options that you have never seen before.
    </p>
      ...
      <div class="row">
        ...
        <div class="feature-col col-lg-4 col-xs-12">
          <div class="card card-block text-center">
            ...
            <div>
              <h3>
                  Innovative Ideas to Save your money and utilize it in best way
                </h3>
